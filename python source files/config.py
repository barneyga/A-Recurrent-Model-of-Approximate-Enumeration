...
core_arg.add_argument(
    "--include_stop", type=str2bool, default=True, help="Whether to use stop_model.py (vs model.py)"
)
...
train_arg.add_argument(
    "--hesitation_penalty", type=float, default=0.1, help="Penalty for each step of compuation"
)
train_arg.add_argument(
    "--lr_patience",
    type=int,
...
misc_arg.add_argument(
    "--hard_coded_path", type=str, default=True, help="date cancer"
)
misc_arg.add_argument(
...
misc_arg.add_argument(
    "--num_channels", type=int, default=1, help="Number of channels in dataset"
)
misc_arg.add_argument(

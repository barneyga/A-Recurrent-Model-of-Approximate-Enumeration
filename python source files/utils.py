...
def prepare_dirs(config):
    for path in [config.data_dir, config.model_dir, config.logs_dir]:
...
def save_config(config):
    ...
    param_path = os.path.join(config.model_dir, filename)

    print("[*] Model Checkpoint Dir: {}".format(config.model_dir))
